...
const trueContainer = document.querySelector('.container') as HTMLDivElement;

//*-------  The operateur : ? ----------

// optional properties
// facultatives properties
...
const WILD_CODE_CODING_GIRL : Job = {
    title: "Dev FullStack",
    salaryInK : 60,
}
...
const littleHouseOnTheHill : House = {
    room: 1,
    priceInK: 2,
    // but no garage :c
};
